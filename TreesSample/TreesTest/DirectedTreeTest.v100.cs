...
namespace TreesTest.v100
{
	...
	public class DirectedTreeTest
	{
		...
		public void Parse_7()
		{
			CollectionAssert.AreEqual(new[] { (0, 1), (1, 2), (3, 1), (0, 4), (5, 4), (6, 4) }, DirectedTree.Parse("0(+(+()-())+(-()-()))"));
			CollectionAssert.AreEqual(new[] { (1, 0), (2, 0), (3, 0), (3, 4), (4, 5), (6, 4) }, DirectedTree.Parse("0(-()-()-(+(+()-())))"));
			CollectionAssert.AreEqual(new[] { (0, 1), (2, 0), (3, 0), (3, 4), (5, 4), (6, 4) }, DirectedTree.Parse("0(+()-()-(+(-()-())))"));
			CollectionAssert.AreEqual(new[] { (0, 1), (2, 1), (3, 1), (3, 4), (4, 5), (6, 4) }, DirectedTree.Parse("0(+(-()-(+(+()-()))))"));
			CollectionAssert.AreEqual(new[] { (0, 1), (1, 2), (3, 1), (3, 4), (5, 4), (6, 4) }, DirectedTree.Parse("0(+(+()-(+(-()-()))))"));
			CollectionAssert.AreEqual(new[] { (1, 0), (2, 1), (3, 1), (3, 4), (5, 4), (6, 4) }, DirectedTree.Parse("0(-(-()-(+(-()-()))))"));
		}
	}
}
